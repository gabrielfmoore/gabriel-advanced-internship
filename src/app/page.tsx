      ...
      <nav className="nav">
        <div className="nav__wrapper">
          ...
          <ul className="nav__list--wrapper">
            <li onClick={() => setModalActive(true)} className="nav__list nav__list--login">Login</li>
          ...
          <div className="row">
            <div className="landing__wrapper">
              <div className="landing__content">
                ...
                <button onClick={() => setModalActive(true)} className="btn home__cta--btn">Login</button>
              </div>
          ...
          <div className="row">
            ...
            <div className="statistics__wrapper">
              <div className="statistics__content--header">
                {LEFT_HEADINGS.map((heading, index) => (
                  <div
                    key={heading}
                    className={
                      index === activeIndex
            ...
            <div className="statistics__wrapper">
              ...
              <div className="statistics__content--header statistics__content--header-second">
                {RIGHT_HEADINGS.map((heading, index) => (
                  <div
                    key={heading}
                    className={
                      index === activeIndex
